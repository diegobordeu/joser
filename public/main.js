...
module.exports = "\n<img src=\"/assets/fat.gif\"  height=\"400\" width=\"400\">\n<div class=\"\" *ngFor=\"let tes of test\">\n  <a href=\"#\">{{tes.title}}</a>\n  <p>{{tes.opening_crawl}}</p>\n</div>\n"
...
var TestComponent = /** @class */ (function () {
    ...
    TestComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('https://swapi.co/api/films').subscribe(function (data) {
            console.log(data);
            _this.test = data.results;
        });
    };
...
module.exports = __webpack_require__(/*! C:\Users\dbord\Documents\repos\joser\src\main.ts */"./src/main.ts");
